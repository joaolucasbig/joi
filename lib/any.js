...
module.exports = internals.Any = function () {
    ...
    this._refs = [];
    this._flags = {
        presence: 'required',                   // optional, required, forbidden, ignore
        /*
        allowOnly: false,
...
internals.Any.prototype.test = function (testFunc) {
    ...
    obj._tests.push({
        func: function(value, state, options) {
            ...
            if (result === false) {
                return Errors.create('any.invalid', { value: value }, state, options);
            } else {
                return null;
            }
        },
