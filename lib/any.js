...
internals.Any.prototype.when = function (ref, options) {
    ...
    var then = options.then ? this.concat(Cast.schema(options.then)) : undefined;
    var otherwise = options.otherwise ? this.concat(Cast.schema(options.otherwise)) : undefined;
